...
from ..layers.packnet.layers01 import \
...
class PackNet01(nn.Module):
    ...
    def forward(self, rgb, min_depth=0.1, max_depth=100.0):
        """
        ...
        # if self.training:
        # return [self.disp_to_depth(disp1), self.disp_to_depth(disp2), self.disp_to_depth(disp3), self.disp_to_depth(disp4)]
        return [1/disp1, 1/disp2, 1/disp3, 1/disp4]
